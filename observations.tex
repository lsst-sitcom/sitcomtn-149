...
\figRef{comcam_science_day_obs} shows the distribution of science program observations by night (\texttt{day\_obs}) during the ComCam on-sky campaign.
...
\figRef{comcam_science_day_obs_ecdfs} shows observations for the ECDFS field, which received the densest and most consistent temporal sampling of the seven target fields during the campaign.
