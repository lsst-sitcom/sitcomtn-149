...
\begin{figure}
  ...
  \caption{A view of detector \czw{R22_S10} in y-band, which has a large number of less significant vampire pixels.}
\end{figure}
...
\begin{figure}
  \includegraphics{figures/isr-f05-gain_ratios_by_flat.png}
  \caption{A comparison of the gain ratio between amplifiers in R22_S12.  C07 is chosen as the indicator amplifier, and C04 is the reference.  We have three twilight flat measurements taken at different rotator angles, and one from the 94 input sky flat.}
\end{figure}
