...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[height=0.6\textheight]{throughput_for_focused_light_figures/cbp_on_dome_2.png}
  \end{center}
  \caption{Image of the CBP, which was installed on the dome on November 22.}
  \label{fig:cbp_2}
\end{figure}
...
\begin{figure}[htbp]
  \includegraphics[height=0.5\textheight]{throughput_for_focused_light_figures/laser_on_dome.png}
